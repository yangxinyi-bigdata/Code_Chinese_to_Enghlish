...
def 创建英文文件夹(项目_根路径):
    ...
    项目_中文目录表单: pd.DataFrame = pd.DataFrame(columns=["文件夹名称", "英文变量", "相对路径",
                                    "英文相对路径", "上层路径", "英文上层路径", "修改标识"])
    id = 0
    id2 = 0
        ...
        if not 项目_中文目录表单.loc[索引, "修改标识"]:
            ...
            for 索引_内层 in 项目_中文目录表单.index:
                if 索引 != 索引_内层:  # 如果不是当前处理目录
                    if 项目_中文目录表单.loc[索引_内层, "英文相对路径"].find(项目_中文目录表单.loc[索引, "相对路径"]) > -1:
                        # 上层目录修改过, 标记一下
                        项目_中文目录表单.loc[索引_内层, "修改标识"] = 1
                        项目_中文目录表单.loc[索引_内层, "英文相对路径"] = 项目_中文目录表单.loc[索引_内层, "英文相对路径"].replace(
                            项目_中文目录表单.loc[索引, "相对路径"], 项目_中文目录表单.loc[索引, "英文相对路径"])

                        项目_中文目录表单.loc[索引_内层, "英文上层路径"] = 项目_中文目录表单.loc[索引_内层, "英文上层路径"].replace(
                            项目_中文目录表单.loc[索引, "相对路径"], 项目_中文目录表单.loc[索引, "英文相对路径"])
            ...
            for 索引_内层 in 项目_中文目录表单.index:
                if 索引 != 索引_内层:  # 如果不是当前处理目录
                    if 项目_中文目录表单.loc[索引_内层, "相对路径"].find(项目_中文目录表单.loc[索引, "相对路径"]) > -1:
                        ...
                        项目_中文目录表单.loc[索引_内层, "英文相对路径"] = 项目_中文目录表单.loc[索引_内层, "英文相对路径"].replace(
                            项目_中文目录表单.loc[索引, "相对路径"], 项目_中文目录表单.loc[索引, "英文相对路径"])
                        项目_中文目录表单.loc[索引_内层, "英文上层路径"] = 项目_中文目录表单.loc[索引_内层, "上层路径"].replace(
                            项目_中文目录表单.loc[索引, "相对路径"], 项目_中文目录表单.loc[索引, "英文相对路径"])
...
if __name__ == '__main__':
    ...
    项目_文件表单 = pd.DataFrame(columns=["文件名称", "英文变量", "相对路径",
                                    "英文相对路径", "上层路径", "英文上层路径", "修改标识"])
    项目_中文文件表单: pd.DataFrame = pd.DataFrame(columns=["文件名称", "英文变量", "相对路径",
                                    "英文相对路径", "上层路径", "英文上层路径", "修改标识"])
    ...
    for 索引 in 项目_中文文件表单.index:
        if 项目_中文文件表单.loc[索引, "上层路径"] in 项目_中文目录表单.相对路径.values:  # 说明是中文路径中, 中文路径会复制一个英文路径, 所以中文路径中的不用处理
            pass
        elif 项目_中文文件表单.loc[索引, "英文上层路径"] in 项目_中文目录表单.英文相对路径.values:
